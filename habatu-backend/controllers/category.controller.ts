...
import { createCategory as create, getCategorys as gets, updateCategorys as update, getCategory as get, deleteCategory as remove } from "../services/category.service";
