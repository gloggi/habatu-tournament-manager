...
import {  createTournamentFinals, getGamesPreview, getGroupTable, getTimePreview, getTournamentRanking, getTournamentTable, addGameToReferee } from '../controllers/tournament.controller';
