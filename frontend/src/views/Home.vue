<template>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6  gap-4 ">
        <Card v-for="item in menuList" :key="item.name" class="text-foreground aspect-square cursor-pointer" @click="handleRouteChange(item.routeName)">
...
import { Table, Medal, Binoculars, UsersIcon, UserRoundPen, CircleGauge, MessageCircleIcon } from 'lucide-vue-next'
