<template>
	<div
		...
		:style="`background: ${game.category.color}; ${game.type=='grandFinale'?'border-width:2px;border-color: #ffd700;':''} ${game.type=='petiteFinale'?'border-width:2px;border-color: #bf8970;':''}`"
		:key="i">
